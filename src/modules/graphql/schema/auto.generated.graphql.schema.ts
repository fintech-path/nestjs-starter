...
export abstract class IMutation {
    abstract token(username?: Nullable<string>, password?: Nullable<string>): Nullable<string> | Promise<Nullable<string>>;

    abstract createCat(createCatInput?: Nullable<CreateCatInput>): Nullable<Cat> | Promise<Nullable<Cat>>;

    abstract deleteCat(id: number): Nullable<Cat> | Promise<Nullable<Cat>>;
}
